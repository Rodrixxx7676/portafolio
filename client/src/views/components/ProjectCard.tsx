...
export function ProjectCard({
  ...
  return (
    // El resplandor pone su propio fondo y borde, así que la tarjeta ya no
    // lleva los suyos: duplicarlos dejaría un doble marco a la vista.
    <BorderGlow borderRadius={16} className="h-full">
      <article
        role="button"
        tabIndex={0}
